...
public class LetterBoxerEditor : Editor
{
    ...
    void OnEnable()
    {
        ...
        createCam = serializedObject.FindProperty("addExtraCamera");
    }
    ...
    override public void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(createCam, new GUIContent("Add extra camera", "Boh"));
